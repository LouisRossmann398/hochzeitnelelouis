...
const translations = {
    de: {
        ...
        locationLabel: 'Ort',
        travelLabel: 'Anreise',
        travelText: 'Parkplätze gibt es direkt vor Ort. Mit öffentlichen Verkehrsmitteln kommt man leider nicht hin – bitte plant die Anreise mit dem Auto.',
        routeText: 'Route',
        dresscodeLabel: 'Dresscode',
        dresscodeText: 'Smart casual / sommerlich-festlich',
        scheduleLabel: 'Ablauf',
        arrivalText: 'Ankommen',
        arrivalDesc: '🧡 Ankommen, Platz suchen & erste Getränke',
        ceremonyText: 'Freie Trauung',
        ceremonyDesc: '💍 Jetzt wird\'s ernst!',
        receptionText: 'Sektempfang',
        coffeeText: 'Kaffee & Kuchen',
        coffeeDesc: '☕ Anstoßen, Kuchen und gemütlich zusammenkommen',
        groupPhotoText: 'Gruppenfoto',
        groupPhotoDesc: '📸 Alle einmal zusammen – bitte nicht verschwinden!',
        barnText: 'Einzug in die Tenne',
        dinnerText: 'Abendessen',
        dinnerDesc: '🍽️ Zeit für gutes Essen und Reden',
        partyText: 'Party',
        partyDesc: '🕺 Jetzt darf getanzt werden!',
    ...
    en: {
        ...
        travelText: 'Parking is available on site. Unfortunately, there is no public transport – please plan to arrive by car.',
        routeText: 'Route',
        dresscodeLabel: 'Dress Code',
        dresscodeText: 'Smart casual / summerly festive',
        scheduleLabel: 'Schedule',
        arrivalText: 'Arrival',
        arrivalDesc: '🧡 Arrive, find your spot & first drinks',
        ceremonyText: 'Free Ceremony',
        ceremonyDesc: '💍 Now it gets serious!',
        receptionText: 'Champagne Reception',
        coffeeText: 'Coffee & Cake',
        coffeeDesc: '☕ Toast, cake and coming together',
        groupPhotoText: 'Group Photo',
        groupPhotoDesc: '📸 Everyone together – please don\'t disappear!',
        barnText: 'Entering the Barn',
        dinnerText: 'Dinner',
        dinnerDesc: '🍽️ Time for good food and speeches',
        partyText: 'Party',
        partyDesc: '🕺 Time to dance!',
